	...
	<view>
		...
		<view class="page_widthMoudel padding_bottom3">
			...
			<view class="tab_moudel">
				<view class="margin_left2 margin_top5">
			...
			<block v-if="discoveryData.length > 0">
				<view class="font_size32 font_color22 margin_top5">精选发现</view>
				<view class="margin_top3 " style="border-radius: 10upx;line-height: 0;overflow: hidden;">
			...
			<!-- 精选信用卡 -->
			<view v-if="creditCardList.length > 0" class="font_size32 font_color22 margin_top5">精选信用卡</view>

			<view class="uni-flex">
				<scroll-view scroll-x="true" class="wrapper">
					<view :class="index != 0 ? 'margin_left3' : ''" class="card_moudel" v-for="(item, index) in creditCardList" :key="index">
			...
			<!-- 热门资讯 -->
			<view class="font_size32 font_color22 margin_top5">热门资讯</view>
			<view class="moudel_list uni-flex" @click="goHotDetail">
				<view class="width33"><image :src="courseData.pictureUrl" style="width: 180upx;height: 180upx;" mode=""></image></view>
				<view class="width66">
					<view class="font_size30 font_color22 font_weight700">{{courseData.periodsNum}}</view>
					<view class="font_size24 font_color99 text_hidden margin_top2">{{courseData.title}}</view>
					<view class="uni-flex margin_top8 font_size22 font_color66 display_right">
						<view class="">
							已更新
							<text class="font_color33">{{courseData.periodsupdatenum}}</text>
							期
						</view>
						<view class="margin_left3">
							共
							<text class="font_color33">{{courseData.periodsNum}}</text>
							期
						</view>
					</view>
				</view>
			...
			<view class="uni-flex  margin_top5">
				<view class="font_size32 font_color22 width50">精选贷款</view>
			...
			<view class="moudel_list margin_top3">
				<view
					@click="goPage('productDetails', '112')"
