	...
	<view>
		<view class="background_colorff padding_top3 " style="padding-top:calc(30upx +  var(--status-bar-height))">
			...
			<view class="page_widthMoudel margin_top5">
				...
				<view @click="getValue(item)" class="display_inline width45 font_sise28 margin_top3"  v-for="(item, index) in hotList" :key="index">
					{{item.label}}
				</view>
				
				
				<view class="font_size30 font_weight700 margin_top6">
					历史搜索
				</view>
