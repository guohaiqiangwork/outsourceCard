			...
			<view class="login_moudel">
				...
				<view class="margin_top3u">
					<view class="uni-flex display_space">
						<view class="font_size40 font_color22">{{ userPhone }}</view>
						<view class="" @click="yzm_function">{{ countdown }}</view>
					</view>
					...
					<view class="font_sise24 font_colorf4 margin_top3">{{ msgErr }}</view>
				</view>
